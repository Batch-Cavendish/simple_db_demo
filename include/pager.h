 ...
 * of "pages" so the rest of the database doesn't have to deal with file
 * offsets. Databases use fixed-size pages to match the physical blocks on disk,
 * which optimizes I/O performance.
 */
